"""
Config for MCR algorithm.
"""

from robomimic.config.base_config import BaseConfig


class MCRConfig(BaseConfig):
    ALGO_NAME = "mcr"

    def train_config(self):
        """
        MCR algorithms don't need "next_obs" from hdf5 - so save on storage and compute by disabling it.
        """
        super(MCRConfig, self).train_config()
